...
public:
     ...
     *  @param managed true, if the new wrapper object owns the wl_data_offer object and is responsible for destryoing it
     */
    data_offer(wl_proxy* obj = nullptr, bool managed = true);
