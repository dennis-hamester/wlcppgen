...
public:
     ...
     *  @param managed true, if the new wrapper object owns the wl_region object and is responsible for destryoing it
     */
    region(wl_proxy* obj = nullptr, bool managed = true);
